...
> CoBridge maneja la recepción y gestión del contexto en el IDE, mientras que Voyager captura y envía el contenido de las conversaciones desde la interfaz web. ¡Juntos, permiten que tu asistente IDE realmente entienda tu historial de chat web!
...
Abre el mercado Open VSX, busca [**CoBridge**](https://open-vsx.org/extension/windfall/co-bridge), y haz clic en instalar. Es así de simple.

Después de la instalación, mira la barra de estado en la esquina inferior derecha — verás un icono que te invita a seleccionar un Agent.
![Icono instalado](../public/assets/installed.png)

Hacer clic en este icono abre un menú donde puedes:
...
- **Seleccionar Agent** (Cambiar de Agent)

### 2. Seleccionar Agent

Abre el menú y selecciona el Agent que estás usando.

![Menú de gestión](../public/assets/management.png)

Actualmente se soportan **6** tipos de Agents de programación:

![Seleccionar Agent](../public/assets/select_agent.png)

Una vez seleccionado, la barra de estado mostrará el icono del Agent correspondiente:

![Agent seleccionado](../public/assets/agent_selected.png)

### 3. Iniciar servicio

Vuelve al menú y haz clic en **Iniciar servicio**. El servicio se ejecutará continuamente hasta que lo detengas manualmente.

![Estado de ejecución](../public/assets/running.png)

### 4. Comenzar la "Teletransportación de Memoria"

Asegúrate de que **Voyager** en tu navegador tenga habilitada la "Sincronización de Contexto". Haz clic en **Sync to IDE**, y el contenido de la conversación aterrizará automáticamente en:
...
- **Configuración Automática**: También genera automáticamente archivos de reglas adaptados a varios Agents, permitiéndoles leer el contexto sin problemas y sin redundancia.
...
**Los LLMs ya no tendrán amnesia. Discute soluciones a fondo en la web e impleméntalas directamente con tu Agent.**
