...
افتح سوق Open VSX، ابحث عن [**CoBridge**](https://open-vsx.org/extension/windfall/co-bridge)، وانقر على تثبيت. الأمر بسيط للغاية.

بعد التثبيت، ألقِ نظرة على شريط الحالة في أسفل اليمين — سترى رمزًا يطلب منك اختيار Agent.
![الرمز المثبت](../public/assets/installed.png)

النقر على هذا الرمز يفتح قائمة حيث يمكنك:
...
- **اختيار Agent** (التبديل بين Agents)

### 2. اختيار Agent

افتح القائمة واختر Agent الذي تستخدمه.

![قائمة الإدارة](../public/assets/management.png)

حاليًا يتم دعم **6** أنواع من Agents البرمجية:

![اختيار Agent](../public/assets/select_agent.png)

بمجرد الاختيار، سيعرض شريط الحالة رمز Agent المقابل:

![تم اختيار Agent](../public/assets/agent_selected.png)

### 3. بدء الخدمة

عد إلى القائمة وانقر على **بدء الخدمة**. ستستمر الخدمة في العمل حتى تقوم بإيقافها يدويًا.

![حالة التشغيل](../public/assets/running.png)

### 4. بدء "النقل الآني للذاكرة"
