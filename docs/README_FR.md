...
> CoBridge gère la réception du contexte dans l'IDE, tandis que Voyager capture le contexte depuis l'interface web. Ensemble, ils permettent une synchronisation transparente du contexte !
